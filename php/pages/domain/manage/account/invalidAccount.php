...
<div class="col-md-12">
	<div class="col-middle">
		<div class="text-center text-center">
			...
			<h2>Sorry but we couldn't find the account you were looking for</h2>
			<p>The account that was requested does not exist! <a href="#">Report this?</a></p>
			<p>Account ID: <?=$_GET['acid']?></p>
